		...
		<header class="aspv5-reveal mb-6">
			<div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
				...
				<div class="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-2xl p-1">
					<button class="aspv5-layout-btn <?php echo 'grid' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors" data-layout="grid" title="<?php esc_attr_e( 'Grid view', 'aspv5' ); ?>" aria-label="<?php esc_attr_e( 'Switch to grid layout', 'aspv5' ); ?>">
					...
					<button class="aspv5-layout-btn <?php echo 'list' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors" data-layout="list" title="<?php esc_attr_e( 'List view', 'aspv5' ); ?>" aria-label="<?php esc_attr_e( 'Switch to list layout', 'aspv5' ); ?>">
					...
					<button class="aspv5-layout-btn <?php echo 'banner' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors" data-layout="banner" title="<?php esc_attr_e( 'Poster view', 'aspv5' ); ?>" aria-label="<?php esc_attr_e( 'Switch to poster/banner layout', 'aspv5' ); ?>">
					...
					<button class="aspv5-layout-btn <?php echo 'compact' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors" data-layout="compact" title="<?php esc_attr_e( 'Compact view', 'aspv5' ); ?>" aria-label="<?php esc_attr_e( 'Switch to compact layout', 'aspv5' ); ?>">

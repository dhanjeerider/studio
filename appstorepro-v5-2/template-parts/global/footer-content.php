...
<footer class="bg-gray-900 dark:bg-black text-gray-300 mt-16 pb-20 md:pb-0">
	<?php if ( $footer_ad_code ) : ?>
	<div class="max-w-6xl mx-auto px-4 pt-6 aspv5-ad-slot aspv5-ad-footer">
		<?php echo do_shortcode( wp_kses_post( $footer_ad_code ) ); ?>
	</div>
	<?php endif; ?>
	...
	<div class="max-w-6xl mx-auto px-4 pt-12 pb-8">
		...
		<div class="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
			...
			<?php else : ?>
				<ul class="flex gap-4">
					<li><a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>" class="hover:text-white transition-colors"><?php esc_html_e( 'Privacy', 'aspv5' ); ?></a></li>
					<li><a href="<?php echo esc_url( home_url( '/terms/' ) ); ?>" class="hover:text-white transition-colors"><?php esc_html_e( 'Terms', 'aspv5' ); ?></a></li>
				</ul>
			<?php endif; ?>
		</div>
	</div>

...
$current_layout = isset( $GLOBALS['aspv5_current_layout'] ) ? $GLOBALS['aspv5_current_layout'] : 'grid';
?>
<div class="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-2xl p-1" role="group" aria-label="<?php esc_attr_e( 'Layout options', 'aspv5' ); ?>">
	<button class="aspv5-layout-btn <?php echo 'grid' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors"
	        data-layout="grid"
	...
	<button class="aspv5-layout-btn <?php echo 'list' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors"
	        data-layout="list"
	...
	<button class="aspv5-layout-btn <?php echo 'banner' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors"
	        data-layout="banner"
	...
	<button class="aspv5-layout-btn <?php echo 'compact' === $current_layout ? 'active' : ''; ?> flex items-center justify-center w-9 h-9 rounded-xl text-gray-500 dark:text-gray-400 transition-colors"
	        data-layout="compact"
